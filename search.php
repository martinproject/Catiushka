...
<div id="search-results" class="container">
	<div class="container_12 clearfix">
		<div class="grid_12"><h3 class="page-title"><?php _e('Search Results', 'autotrader') ?></h3></div>
		...
		<div id="content" class="grid_8">	
			...
			<?php endwhile; 
					...
					<h2><?php _e("Your search did not match any entry.",'autotrader'); ?></h2>			
			<?php endif; ?>
